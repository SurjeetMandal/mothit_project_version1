...
const SessionContact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          toast.success("Your Session detail will be shared shortly.");
        },
        () => {
        ...
        <div className="myContainer !pt-10 md:!pt-20">
          ...
          >
            <form className="md:w-[50%]" onSubmit={sendEmail} ref={form}>
              <p className="text-3xl text-[var(--text_normal)]">Expert Session</p>
              <p className="text-[var(--text_normal)]">Fill all the detail below to book session.</p>
